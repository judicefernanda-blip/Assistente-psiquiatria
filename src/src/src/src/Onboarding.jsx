    ...
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        <div style={s.body}>
          ...
          {passo===2 && (
            <>
              <p style={{fontSize:14,color:"#888",marginBottom:20,lineHeight:1.6}}>Selecione sua especialidade principal. O assistente vai se adaptar automaticamente.</p>
              <div style={s.specGrid}>
                {ESPECIALIDADES.map(e=>(
                  <div key={e.value} style={s.specCard(especialidade===e.value)} onClick={()=>setEspecialidade(e.value)}>
                    ...
                    <div style={{fontSize:11,fontWeight:600,color:especialidade===e.value?ROSE:"#555",letterSpacing:0.5}}>{e.label}</div>
                  </div>
                ))}
              </div>
          ...
          {passo===3 && (
            <>
              <p style={{fontSize:14,color:"#888",marginBottom:20,lineHeight:1.6}}>Como você pratica medicina? Isso nos ajuda a personalizar ainda mais o assistente.</p>
